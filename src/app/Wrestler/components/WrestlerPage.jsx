    ...
    <div className="container-fluid">
      ...
      <div className="row">
        <div className="col-8">
          ...
          <br />
          <br />
          <h2 className="h2-wrestler">Individual/Postseason - Career</h2>
          <WrestlerPageTable data={individualData} type="individual" />
        </div>
        <div className="col-4">
          <h2 className="h2-wrestler">Wrestler Statistics</h2>
          <p className="notes">
            *Note: some statistics are only counted in the regular season,
            wins/losses, match times, and periods are counted in regular and
            post season.
          </p>
        ...
        {seasonList.map((season) => {
          return (
            <>
              <h2>Season {season}</h2>
              <RadarChart
                chartData={careerStats.filter((sea) => sea.season === season)}
              />
            </>
          );
        })}
